"""Modelos SQLAlchemy del star schema de Tumi Analytics.

Fuente única de verdad de los modelos, compartida entre backend y ETL.
El esquema físico se versiona con Alembic (migraciones).
"""
...
class DailyCityFact(Base):
    ...
    __table_args__ = (
        UniqueConstraint("city_id", "date_id", name="uq_fact_daily_city_city_date"),
    )
